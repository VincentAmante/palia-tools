<template>
  <div class="grid md:grid-cols-3 items-center gap-2 px-2 text-center lg:px-12 max-w-420">
    <NuxtLink
to="https://docs.google.com/document/d/1bjqQGwzhW7wsIpSDoO3xCMwqbX7ZbsdsuuXmPEXCrjE/" target="_blank"
      ...
      <font-awesome-icon :icon="['fas', 'book-open']" class="mr-1 text-lg" />
      <p class="items-center gap-2 text-sm font-semibold wrap-break-word md:text-base md:flex">
        Shepp Arenvanya's Guide to Gardening
        <font-awesome-icon :icon="['fas', 'arrow-up-right-from-square']" class="mr-1 text-xs opacity-50" />
      </p>
    </NuxtLink>
    <NuxtLink
to="https://ko-fi.com/aisencrown" target="_blank" :prefetch="false"
      ...
      <img src="https://pgp-cdn.b-cdn.net/kofi.webp" alt="Ko-fi Logo" width="28" class="mr-1" >

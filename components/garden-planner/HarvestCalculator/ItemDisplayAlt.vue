...
<template>
  <li
    class="relative flex flex-col items-center justify-center w-10 h-10 rounded-sm isolate aspect-square bg-accent dark:bg-palia-blue-secondary"
  >
    <!-- <div
    ...
    <div class="relative w-full h-full p-2 rounded-md isolate overflow-clip">
      <div class="absolute top-0 left-0 w-full h-full rounded-md select-none opacity-40 -z-10 bg-linear-to-b from-misc to-primary dark:from-palia-blue dark:to-palia-blue-dark" />
      <img
        v-if="imgSrc"
        :src="imgSrc"
        width="28px"

...
id="garden-display" class="flex flex-col items-start px-1 h-full pb-4 sm:pb-0 sm:px-0 overflow-y-auto rounded-sm" :class="[
        ...
        (gardenGrid.isGardenWide) ? 'overflow-x-scroll  max-w-90 xs:max-w-130 sm:max-w-180 md:max-w-220 lg:max-w-235 xl:max-w-7xl bg-misc/10 xl:p-2 xl:px-2 dark:bg-palia-blue-secondary scrollbar scrollbar-h-2 pb-1 scrollbar-thumb-rounded-xl dark:scrollbar-thumb-accent scrollbar-thumb-palia-blue max-h-165' : 'max-w-full w-full max-h-300',
    ]"

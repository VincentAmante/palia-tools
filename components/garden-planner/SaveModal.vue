...
import PGPLayoutSaveForm from './SaveHandler/PGPLayoutSaveForm.vue'
...
<template>
  <PGPModal ref="modal">
    ...
    <template #body>
      ...
      <div
        v-else-if="saveTab === 'link'"
        class="flex flex-col gap-2"
      >
        <PGPLayoutSaveForm :save-code="saveCode.code" />
      </div>
    </template>
  </PGPModal>
</template>

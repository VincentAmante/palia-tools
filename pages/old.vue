...
async function saveAsImage() {
  ...
  const filename = `PaliaGardenPlan-${uniqid()}.svg`
  ...
  domtoimage.toPng(
    ...
    (dataUrl: string) => {
      ...
      download(dataUrl, `PaliaGardenPlan-${uniqid()}.png`)
      ...
      // dl.setAttribute('download', `PaliaGardenPlan-${uniqid()}.svg`)
      // dl.click()
        ...
        >
          <div class="flex flex-col xl:px-2">
            ...
            >
              <section
                :class="[
                  (isTakingScreenshot.get) ? 'w-fit basis-3/6 mx-auto' : 'w-full lg:basis-3/6 xl:basis-3/6 overflow-x-auto',
                  (gardenTilesAreWide) ? 'flex flex-col items-center md:gap-2 py-2' : 'flex flex-col']"
              >
                <h2 class="sr-only">
                  Garden Display
                </h2>
              ...
              <div
                ...
                :class="[(gardenTilesAreWide) ? 'flex flex-col items-center lg:gap-2' : 'pt-4 lg:pt-0',
                         (isTakingScreenshot.get) ? 'basis-2/3' : '']"
              >
                <StatsDisplay
                  ref="statDisplay"
